export async function GET() {
  ...
  const manifest = {
    ...
    miniapp: {
      ...
      description: 'A mini app for managing advertising tokens and connecting advertisers with creators on Base.',
      screenshotUrls: [
        `${URL}/placeholder.jpg`,
        `${URL}/placeholder.jpg`,
        `${URL}/placeholder.jpg`,
      ...
      ogDescription: 'Connect advertisers and creators through on-chain advertising tokens.',
